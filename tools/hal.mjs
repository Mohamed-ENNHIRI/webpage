 ...
 *
 * Usage: node tools/hal.mjs
 */

import { readFileSync, writeFileSync, existsSync } from 'node:fs';

/*
 * L'identifiant d'auteur HAL de Martin. C'est le seul critère de la requête :
 * tout ce qui lui est rattaché dans HAL paraît sur le site, et rien d'autre.
 * Si une publication manque, c'est presque toujours qu'elle n'est pas liée à
 * cet idHAL dans HAL même.
 */
const HAL_ID = 'martin-thebault';
