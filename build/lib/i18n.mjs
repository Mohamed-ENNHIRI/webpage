...
const STRINGS = {
  en: {
    ...
    cadastreTitle: 'Rooftop solar irradiation, Geneva',
    cadastreCaption: 'Every roof surface in one Geneva neighbourhood, coloured by the sunlight it receives over a year. Real data from the published roof-solar cadastre.',
    cadastreThreshold: 'suitable above',
    cadastreRoofs: 'roof surfaces',
    cadastreUnit: 'kWh/m²/year',
    cadastreSource: 'Data: Swiss Federal Office of Energy / swisstopo, open data',
  ...
  fr: {
    ...
    cadastreTitle: 'Irradiation solaire en toiture, Genève',
    cadastreCaption: 'Chaque pan de toiture d’un quartier genevois, coloré selon l’ensoleillement qu’il reçoit sur une année. Données réelles issues du cadastre solaire publié.',
    cadastreThreshold: 'favorables au-delà de',
    cadastreRoofs: 'pans de toiture',
    cadastreUnit: 'kWh/m²/an',
    cadastreSource: 'Données : Office fédéral de l’énergie / swisstopo, données ouvertes',
